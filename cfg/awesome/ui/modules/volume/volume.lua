...
local utils = require("ui.modules.volume.utils")
...
local widget_types = {
    icon_and_text = require("ui.modules.volume.widgets.icon-and-text-widget"),
    icon = require("ui.modules.volume.widgets.icon-widget"),
    arc = require("ui.modules.volume.widgets.arc-widget"),
    horizontal_bar = require("ui.modules.volume.widgets.horizontal-bar-widget"),
    vertical_bar = require("ui.modules.volume.widgets.vertical-bar-widget")
}
local volume = {}
